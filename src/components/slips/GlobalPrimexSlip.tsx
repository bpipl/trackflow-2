...
interface GlobalPrimexSlipProps {
  slip: CourierSlip;
}

export const GlobalPrimexSlip: React.FC<GlobalPrimexSlipProps> = ({ slip }) => {
  ...
  const renderSlip = (copyNum: number) => {
    ...
    return (
      <div key={copyNum} className={`global-slip border-2 border-black rounded-md mb-4 relative ${slip.isCancelled ? 'line-through opacity-70' : ''}`} style={slipStyle}>
        ...
        <div className="grid grid-cols-12 border-b border-black">
          ...
          {/* Global Primex Logo and Address */}
          <div className="col-span-5 border-r border-black text-center p-1 flex flex-col items-center justify-between">
            <div className="font-bold text-xl text-blue-700">Global Primex Logistic</div>
            <div className="text-xs">
              G-4/B, Shatabdi Building, 59 Netaji Place
              <br />
              New Delhi - 110019, Tel.: 011-40140180
              <br />
            ...
            <div className="text-xs italic text-[6px]">
              ...
              or Cash Equivalents or Contraband etc. And also declare that all way bill, GST,
              octroi's responsibility of consignor or consignee.
            </div>
          </div>
        ...
        <div className="grid grid-cols-12 border-b border-black">
          ...
          <div className="col-span-6 border-r border-black p-2">
            <div className="text-xs font-bold border-b border-black pb-1">Consignor</div>
          ...
          <div className="col-span-6 p-2">
            <div className="text-xs font-bold border-b border-black pb-1">Consignee</div>
          ...
          <div className="col-span-8 border-r border-black p-2">
            <div className="grid grid-cols-3 h-full">
              <div className="border-r border-black p-1">
                <div className="text-xs font-bold text-center">Received by GLOBAL PRIMEX</div>
              ...
              <div className="col-span-2 p-1">
                <div className="grid grid-cols-2 mt-2">
                  ...
                  <div className="text-center">Mode of Despatch</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* GST and Service Charges Section */}
        <div className="grid grid-cols-12 text-[8px] border-b border-black">
          <div className="col-span-2 border-r border-black p-1 text-center">
            <div>GST IN</div>
            <div className="font-bold">07FHAPS5516R1ZM</div>
          </div>
          <div className="col-span-2 border-r border-black p-1 text-center">
            <div>CGST</div>
          ...
          <div className="col-span-2 border-r border-black p-1 text-center">
            ...
            <div className="font-bold">₹ {slip.charges || '-'}</div>
          </div>
          <div className="col-span-4 p-1 text-center">
            <div>MODE OF PAYMENT</div>
            <div className="font-bold">{slip.isToPayShipping ? 'TO PAY' : 'PAID'}</div>
          </div>
        </div>
        
        {/* Terms and Condition Footer */}
        <div className="p-1">
          <div className="text-sm font-bold text-blue-700">Sender Copy</div>
          <div className="text-[8px] italic">
            Terms & Conditions: For Global Primex Logistic: (1) It is hereby agreed that in case of any dispute, the matter will be referred to an Arbitrator to be nominated by the company.
            (2) Subject to Booking Area jurisdiction only. (3) No claim without insurance declaration and other Govt. duties.
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div id={`slip-${slip.id}`} className="print-only global-slip-container slip-content">
      {renderSlip(1)}
      {renderSlip(2)}
      {renderSlip(3)}
    </div>
...
export default GlobalPrimexSlip;
