...
interface TrackonSlipProps {
  slip: CourierSlip;
}

export const TrackonSlip: React.FC<TrackonSlipProps> = ({ slip }) => {
  ...
  const renderSlip = (copyNum: number) => {
    ...
    return (
      <div key={copyNum} className={`trackon-slip border-2 border-black rounded-md mb-4 relative ${slip.isCancelled ? 'line-through opacity-70' : ''}`} style={slipStyle}>
        ...
        <div className="grid grid-cols-12 border-b border-black">
          ...
          {/* Trackon Logo and Address */}
          <div className="col-span-5 border-r border-black text-center p-1 flex flex-col items-center justify-between">
            <div className="font-bold text-xl text-orange-600">Trackon Couriers</div>
            <div className="text-xs italic text-orange-600">SWIFT. SAFE. SURE.</div>
            <div className="text-xs">
              Head Office: Trackon Couriers Pvt. Ltd.
              <br />
              New Delhi - 110019, Tel.: 011-40629000
              <br />
              Email: info@trackon.in
            </div>
          ...
          <div className="col-span-8 border-r border-black p-2">
            <div className="grid grid-cols-3 h-full">
              <div className="border-r border-black p-1">
                <div className="text-xs font-bold text-center">Received by TRACKON</div>
        ...
        <div className="border-t border-black p-1">
          <div className="text-sm font-bold text-orange-600">Sender Copy</div>
  ...
  return (
    <div id={`slip-${slip.id}`} className="print-only trackon-slip-container slip-content">
      {renderSlip(1)}
      {renderSlip(2)}
      {renderSlip(3)}
    </div>
